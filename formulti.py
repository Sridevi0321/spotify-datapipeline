...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id= '45444',  # Replace with your Client ID
    client_secret= '44566' # Replace with your Client Secret
))
...
db_config = {
    ...
    'password': '****',         # MySQL password (replace with the actual one if different)
    'database': 'spotify_db'    # Name of the database
}
